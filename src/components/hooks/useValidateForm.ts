...
import { emptyValue, validateString, verifyLetters, verifyNumbers } from "../libs/functionsStrings";
...
export interface TypeUseValidateForm<TypeData> {
  setField: ({
    name,
    value,
  }: {
